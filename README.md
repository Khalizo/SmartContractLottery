...
This is a repo to work with and create a truely random smart contract lottery in a python environment. This project was done part of the [FreeCodeCamp](https://www.freecodecamp.org/news/tag/solidity/) solidity course. 
